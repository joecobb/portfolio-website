    ...
    return <div style={{ marginTop: 90 }} className="container">
        <div className="px-4">
            <div className="position-relative">
                <h1 style={{ textTransform: "uppercase", fontSize: "6rem", zIndex: -1, position: "absolute", top: 58, color: "#161922", width: 510 }} >About Me</h1>
            ...
            <div className="row mt-5">
                ...
                <div className="col-lg-7">
                    <h2 className="text-white mt-5">I am <span style={{ color: "#037fff" }}>Joseph Cobbinah</span></h2>
                    <div className="mt-4" style={{ color: "#a4acc4", fontSize: 18 }}>
            ...
            <div className="position-relative mt-5">
                <h1 style={{ textTransform: "uppercase", fontSize: "6rem", zIndex: -1, position: "absolute", top: 58, color: "#161922", width: 510 }} >Services</h1>
            ...
            <div className="row mt-5">
                <div className="col-lg-4 mt-4">
                    <div style={{ background: "#191D2B", border: "1px solid #2e344e", borderTop: "5px solid #2e344e" }} className="p-4 h-100">
                        <i style={{ color: "#037fff" }} className='fa fa-paint-brush fa-2x'></i>
                        <h4 className="text-white mt-4">Web Design</h4>
                        <div className="mt-3" style={{ width: 40, height: 2, background: "#2E354E" }}></div>
                        <div className="mt-3" style={{ color: "#a4acc4", fontSize: 18 }}>
                ...
                <div className="col-lg-4 mt-4">
                    <div style={{ background: "#191D2B", border: "1px solid #2e344e", borderTop: "5px solid #2e344e" }} className="p-4 h-100">
                        <i style={{ color: "#037fff" }} className='fa fa-code fa-2x'></i>
                ...
                <div className="col-lg-4 mt-4">
                    <div style={{ background: "#191D2B", border: "1px solid #2e344e", borderTop: "5px solid #2e344e" }} className="p-4 h-100">
                        <i style={{ color: "#037fff" }} className='fa fa-android fa-2x'></i>
                ...
                <div className="col-lg-4 mt-4">
                    <div style={{ background: "#191D2B", border: "1px solid #2e344e", borderTop: "5px solid #2e344e" }} className="p-4 h-100">
                        <i style={{ color: "#037fff" }} className='fa fa-globe fa-2x'></i>
