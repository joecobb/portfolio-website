        ...
        <div className="px-4">
            ...
            <div className="position-relative mb-5"  >
                ...
                <div style={{ zIndex: 1, marginTop: 100 }} className="py-3">
                    <ExperienceItem duration={'Jan 2022 - Present'} jobTitle={'Senior Software Engineer'} companyName={'Enterprise Group'} description={'My responsibilities include application development, application support, DevSecOps, engaging and assisting third-party vendors, et cetera. Some of the languages and tools I\'ve used at this role are PHP, Laminas, Laravel, Reactjs, Docker, Git, MySql, MSSQL Server '} />
                    ...
                    <ExperienceItem duration={'Dec 2021 - Jan 2022'} jobTitle={'Software Engineer'} companyName={'Omni Strategies'} description={'My responsibilities were building and maintaining applications. Some of the languages and tools used at this role include React Native, Git, Docker'} />
