            ...
            <div style={{ marginTop: 100 }}>
                <div className="row g-4">
                    ...
                    <div className="col-lg-6 col-md-12">
                        ...
                        <div style={{ color: "#7ba6c1", fontSize: 18 }} >React app I built for Enterprise Life customers to generate quotes for their Annuity Prime Product. Annuity is basically a product that guarantees a monthly salary after pension based on an initial lumpsum paid.</div>
                    </div>
                    <div className="col-lg-6 col-md-12">
                        ...
                        <div style={{ color: "#7ba6c1", fontSize: 18 }} >A fully-fledged ecommerce android app with over 500+ downloads on playstore. Features include a Browse/Filter product, Cart Manangement, Paystack Payment Integration and more. was built with Kotlin.</div>
                    </div>
                    <div className="col-lg-6 col-md-12">
                        ...
                        <div style={{ color: "#7ba6c1", fontSize: 18 }} >A Fashion website with categories of fashionble clothes to choose from. Built in React.</div>
                    </div>
                    <div className="col-lg-6 col-md-12">
                        ...
                        <div style={{ color: "#7ba6c1", fontSize: 18 }} >A website for a cleaning company where visitors can contact them for their services and also start a purchasing process for any of their products. Built with Wordpress.</div>
                    </div>
                    <div className="col-lg-6 col-md-12">
                        ...
                        <div style={{ color: "#7ba6c1", fontSize: 18 }} >I think this is one of the first projects I built. It is website for New Heights School which showcases their The facilities they have as well as some beautiful pictures. Built with vanilla HTML, Javascript and CSS with Google Maps integration</div>
                    </div>
